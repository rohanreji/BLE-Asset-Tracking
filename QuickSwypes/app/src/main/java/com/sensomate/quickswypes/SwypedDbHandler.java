 ...
 */
public class SwypedDbHandler extends SQLiteOpenHelper {
    // All Static variables
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "swypedManager";

    // Contacts table name
    private static final String TABLE_CONTACTS = "swyped";
    ...
    public SwypedDbHandler(Context context) {
