...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME + " TEXT,"+KEY_SI_NA+" TEXT,"
    ...
    EmpDetails getContact(int id) {
        ...
        EmpDetails contact = new EmpDetails(Integer.parseInt(cursor.getString(0)),
